...
def partition(user_ids,i,k):
    # this function will partition the list in two parts divided by
    # partition_index, all on left side will be less than pivot and
    # all on the right side will be greater than pivot
    pivot=(i+k)//2
    partition_index=i
